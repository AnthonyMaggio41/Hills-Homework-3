...
public class SubjectService {
    ...
    public List<Subject> getAllSubjects() {
       Query<Entity> query = Query.newEntityQueryBuilder()
        ...
        return buildSubject(entities);
    }
private List<Subject> buildSubject(Iterator<Entity> entities) {
        List<Subject> subject = new ArrayList<>();
        entities.forEachRemaining(entity -> subject.add(entityToSubject(entity)));
        return subject;
    }
